...
const FieldDetails = () => {
    ...
    const getCropName = (crop: CropTypes) => {
        const crops: Record<number, string> = {  1: 'Пшеница', 2: 'Ръж', 3: 'Зелен грах', 4: 'Фацелия', 5: 'Слънчоглед', 6: 'Царевица', 7: 'Угар',
            8: 'Люцерна', 9: 'Изкуствени ливади - смесени насаждения', 10: "Мека пшеница - зимна", 11: "Грах за зърно - пролетен", 12: "Ливади за косене", 13: "Фуражен грах"  };
    ...
    const cropOptions = [
        ...
        { label: "Ливади за косене", value: 12 },
        { label: "Фуражен грах", value: 13 },
    ];
